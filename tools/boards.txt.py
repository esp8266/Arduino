...
macros = {
    ...
    'lwip2': collections.OrderedDict([
        ...
        ( '.menu.ip.lm2s.build.lwip_lib', '-llwip2-536-feat' ),
        ( '.menu.ip.lm2s.build.lwip_flags', '-DLWIP_OPEN_SRC -DTCP_MSS=536 -DLWIP_FEATURES=1' ),
        ( '.menu.ip.hb2s', 'v2 Higher Bandwidth' ),
        ( '.menu.ip.hb2s.build.lwip_include', 'lwip2/include' ),
        ( '.menu.ip.hb2s.build.lwip_lib', '-llwip2-1460-feat' ),
        ( '.menu.ip.hb2s.build.lwip_flags', '-DLWIP_OPEN_SRC -DTCP_MSS=1460 -DLWIP_FEATURES=1' ),
