...
boards = collections.OrderedDict([
    ...
    ('espectro', {
        ...
        'desc': [
            'ESPectro Core is ESP8266 development board as the culmination of our 1+ year experience in exploring and developing products with ESP8266 MCU.',
            ...
            'More details at https://shop.makestro.com/en/product/espectro-core',
        ],
    })
    ])
