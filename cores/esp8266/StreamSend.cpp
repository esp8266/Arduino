...
size_t Stream::sendGeneric(Print* to,
                           ...
                           const PolledTimeout::oneShotFastMs::timeType timeoutMs)
{
...
size_t Stream::SendGenericPeekBuffer(Print* to, const ssize_t len, const int readUntilChar, const PolledTimeout::oneShotFastMs::timeType timeoutMs)
{
    // "neverExpires (default, impossible)" is translated to default timeout
    PolledTimeout::oneShotFastMs timedOut(timeoutMs >= PolledTimeout::oneShotFastMs::neverExpires ? getTimeout() : timeoutMs);
...
size_t Stream::SendGenericRegularUntil(Print* to, const ssize_t len, const int readUntilChar, const PolledTimeout::oneShotFastMs::timeType timeoutMs)
{
    // regular Stream API
...
size_t Stream::SendGenericRegular(Print* to, const ssize_t len, const PolledTimeout::oneShotFastMs::timeType timeoutMs)
{
    // regular Stream API
