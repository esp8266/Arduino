...
static const uint8_t D3  = 0;  // 12k-up                       (boot:flash=up,uart=down)
static const uint8_t D4  = 2;  // 12k-up LED         i2so-ws   (boot:up)   uart1-tx
...
static const uint8_t D8  = 15; // 12k-down  spi-ss   i2so-bck  (boot:down) uart0-swapped-tx
static const uint8_t D9  = 3;  // uart0-rx           i2so-data
