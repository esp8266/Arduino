...
String ESP8266WiFiMesh::getMeshName()
{
    return _meshName;
}
...
String ESP8266WiFiMesh::getNodeID()
{
    return _nodeID;
}
...
String ESP8266WiFiMesh::getSSID()
{
    return _SSID;
}

void ESP8266WiFiMesh::setMessage(const String &newMessage)
{
    _message = newMessage;
}
String ESP8266WiFiMesh::getMessage()
{
    return _message;
}

void ESP8266WiFiMesh::setRequestHandler(ESP8266WiFiMesh::requestHandlerType requestHandler)
{
    _requestHandler = requestHandler;
}
ESP8266WiFiMesh::requestHandlerType ESP8266WiFiMesh::getRequestHandler()
{
    return _requestHandler;
}

void ESP8266WiFiMesh::setResponseHandler(ESP8266WiFiMesh::responseHandlerType responseHandler)
{
    _responseHandler = responseHandler;
}
ESP8266WiFiMesh::responseHandlerType ESP8266WiFiMesh::getResponseHandler()
{
    return _responseHandler;
}

void ESP8266WiFiMesh::setNetworkFilter(ESP8266WiFiMesh::networkFilterType networkFilter)
{
    _networkFilter = networkFilter;
}
ESP8266WiFiMesh::networkFilterType ESP8266WiFiMesh::getNetworkFilter()
{
    return _networkFilter;
}
...
bool ESP8266WiFiMesh::getScanHidden()
{
    return _scanHidden;
}
...
bool ESP8266WiFiMesh::getAPHidden()
{
    return _apHidden;
}
...
bool ESP8266WiFiMesh::getMaxAPStations()
{
    return _maxAPStations;
}
...
int32_t ESP8266WiFiMesh::getConnectionAttemptTimeout()
{
    return _connectionAttemptTimeoutMs;
}
...
int ESP8266WiFiMesh::getStationModeTimeout()
{
    return _stationModeTimeoutMs;
}
...
uint32_t ESP8266WiFiMesh::getAPModeTimeout()
{
    return _apModeTimeoutMs;
}
