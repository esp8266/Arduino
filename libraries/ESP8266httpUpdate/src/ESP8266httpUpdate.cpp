...
HTTPUpdateResult ESP8266HTTPUpdate::update(Client& client, const String& url, const String& currentVersion)
{
    HTTPClient http;
...
HTTPUpdateResult ESP8266HTTPUpdate::updateSpiffs(Client& client, const String& url, const String& currentVersion)
{
    HTTPClient http;
    http.begin(client, url);
    return handleUpdate(http, currentVersion, true);
...
HTTPUpdateResult ESP8266HTTPUpdate::update(Client& client, const String& host, uint16_t port, const String& uri,
        const String& currentVersion)
{
    HTTPClient http;
