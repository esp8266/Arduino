...
void wifi_dns_found_callback(const char *name, ip4_addr_t *ipaddr, void *callback_arg);
#else
void wifi_dns_found_callback(const char *name, const ip4_addr_t *ipaddr, void *callback_arg);
#endif
