...
static void wifi_dns_found_callback_async(const char* name, const ip_addr_t* ipaddr, void* callback_arg);
...
int ESP8266WiFiGenericClass::hostByNameAsync(const char* aHostname, IPAddress& aResult, bool* waiting) {
    ip_addr_t addr;
