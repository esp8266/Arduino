...
"/c/Users/earle/Documents/Arduino/hardware/esp8266com/esp8266/tools/python3/python3" "/c/Users/earle/Documents/Arduino/hardware/esp8266com/esp8266/tools/upload.py" --chip esp8266 --port COM3 --baud 921600 --before default_reset --after hard_reset write_flash 0x0 .build/waveform_sut.ino.bin
