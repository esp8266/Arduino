...
sut = analyzer.ESP8266(port = 'COM7')
...
for f in freqs:
    ...
    for i in range(0, 1001, 10):
        ...
        csv = la.capture(pins = 'D1,D2,D3', samples = 240000, rate = '24mhz')
        ...
        cycleCnt3, avgPeriod3, avgDuty3, periods3, highs3, duties3, stdP3, stdD3 = la.decodePWM(csv, 3)
        running = sut.perfTest()
        print("%d,%d,%d,%.0f,%.4f,%.1f,%.4f,%.0f,%.4f,%.1f,%.4f,%.2f,%f,%f,%f,%f" % (f, i, cycleCnt, avgPeriod, avgDuty, stdP, stdD, avgPeriod2, avgDuty2, stdP2, stdD2,(running / idle),avgPeriod3, avgDuty3,stdP3, stdD3))
